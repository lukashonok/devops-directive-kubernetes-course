...
The demo application builds upon the one used in the [DevOps Directive Docker Course](https://github.com/dembyvlad/devops-directive-docker-course/tree/main/05-example-web-application).
